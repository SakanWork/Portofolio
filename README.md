...
<head>
    ...
    <title>Danish Sakan | Web Developer Portfolio</title>
    ...
    <style>
        :root {
            ...
            --card-bg: #FAFAFA;
            --terminal-bg: #300A24;
            --terminal-text: #D1D1D1;
            --terminal-prompt: #19B6EE;
            --terminal-command: #E95420;
        }
        ...
        <section class="skills" id="skills">
            <div class="container">
                ...
                <div class="skills-grid">
                    ...
                    <div class="skill-card">
                        <div class="skill-icon">
                            <img src="css3.png" alt="CSS3 logo with blue background">
                        </div>
                        <h3>CSS3</h3>
